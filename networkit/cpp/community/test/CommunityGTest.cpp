...
TEST_F(CommunityGTest, testInclusionMinimal) {
  ...
  count minimum = 21;
	Graph karate = METISGraphReader().read("input/karate.graph");
  karate.indexEdges();
  QuasiThresholdMoving::QuasiThresholdEditingLocalMover mover(karate, QuasiThresholdMoving::QuasiThresholdEditingLocalMover::ASC_DEGREE_INSERT, 0, true, false);
  mover.run();
...
TEST_F(CommunityGTest, testInclusionMinimalWeightedCost) {
  ...
  count minimum = 21;
	Graph karate = METISGraphReader().read("input/karate.graph");
  karate.indexEdges();
  QuasiThresholdMoving::QuasiThresholdEditingLocalMover mover(karate, QuasiThresholdMoving::QuasiThresholdEditingLocalMover::ASC_DEGREE_INSERT, 20, true, false, false, 4UL, true, insertEditCost, removeEditCost);
  mover.run();
  Graph Q = mover.getQuasiThresholdGraph();
  count used = mover.getNumberOfEdits();
...
TEST_F(CommunityGTest, testWeightedCostMatrix) {
  ...
  QuasiThresholdMoving::QuasiThresholdEditingLocalMover mover(karate, QuasiThresholdMoving::QuasiThresholdEditingLocalMover::ASC_DEGREE_INSERT, 20, true, false, false, 4UL, true, 1, 1, editCostMatrix);
  mover.run();
  Graph Q = mover.getQuasiThresholdGraph();
  count used = mover.getNumberOfEdits();
  count usedWeight = mover.getWeightOfEdits();
...
TEST_F(CommunityGTest, testMoveSubtreeWeighted) {
  Aux::Random::setSeed(37, false);
  count removeEditCost = 1;
  count insertEditCost = 1;
  count minimum = 21;
	Graph karate = METISGraphReader().read("input/karate.graph");
  karate.indexEdges();
  QuasiThresholdMoving::QuasiThresholdEditingLocalMover mover(karate, QuasiThresholdMoving::QuasiThresholdEditingLocalMover::ASC_DEGREE_INSERT, 20, false, false, true, 4UL, true, insertEditCost, removeEditCost);
  mover.run();
  Graph Q = mover.getQuasiThresholdGraph();
  count used = mover.getNumberOfEdits();
  count usedWeight = mover.getWeightOfEdits();
  ...
  count edgeRemovals = 0;
  count edgeInsertions = 0;
  //GraphDifference difference(karate, Q);
  //difference.run();
